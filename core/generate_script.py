...
def generate_narration_script(
    ...
    # 根据风格选择提示词
    style_guide = {
        "专业解说": "客观冷静，像纪录片解说，注重剧情分析",
        "幽默吐槽": "轻松幽默，用调侃的语气讲故事，但不要写出'吐槽'两个字",
        "悬疑紧张": "营造悬疑氛围，语气紧凑，制造悬念",
        "温情感人": "温暖细腻，注重情感表达，触动人心"
    }
    
    style_desc = style_guide.get(style, style_guide["专业解说"])
...
"""
    ...
    # 风格指南
    style_guide = {
        "专业解说": "客观冷静，像纪录片解说，深入分析剧情和人物",
        "幽默吐槽": "轻松诙谐，用调侃的语气讲故事，制造笑点但不刻意",
        "悬疑紧张": "营造悬疑氛围，语气紧凑有力，层层制造悬念",
        "温情感人": "温暖细腻，注重情感表达，引发共鸣"
    }
